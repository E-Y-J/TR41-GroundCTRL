...
const articleStatusEnum = z.enum(['DRAFT', 'PUBLISHED', 'ARCHIVED', 'NEEDS_REVIEW']);
...
const feedbackTypeEnum = z.enum(['HELPFUL', 'NOT_HELPFUL', 'NEEDS_UPDATE', 'INCORRECT']);

const contentBlockTypeEnum = z.enum([
  'PARAGRAPH',
  'HEADING',
  'LIST',
  'CODE',
...
const calloutTypeEnum = z.enum(['INFO', 'WARNING', 'TIP', 'DANGER', 'SUCCESS']);
  ...
  .object({
    body: z
      .object({
        ...
        type: articleTypeEnum.default('GUIDE').describe('Article format type'),
    ...
    body: z
      .object({
        ...
        answerBlocks: z
          ...
          .optional()
          .describe(
            'Rich content blocks (alternative to plain answer)'
          ),
    ...
    body: z
      .object({
        ...
        user_id: z
          ...
          .optional()
          .describe(
            'FK to users.id (optional for anonymous feedback)'
          ),
