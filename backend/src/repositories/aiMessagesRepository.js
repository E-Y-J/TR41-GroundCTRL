...
async function addMessage(sessionId, userId, role, content, metadata = {}) {
  try {
    ...
    logger.error('Failed to create AI message', { error: error.message, sessionId });
    throw error;
  }
}
...
async function getMessagesBySession(sessionId, options = {}) {
  try {
    ...
    logger.error('Failed to fetch messages by session', { error: error.message, sessionId });
    throw error;
  }
}
...
async function getRecentMessages(sessionId, limit = 10) {
  try {
    ...
    logger.error('Failed to fetch recent messages', { error: error.message, sessionId });
    throw error;
  }
}
...
async function deleteBySession(sessionId, metadata = {}) {
  try {
    ...
    logger.error('Failed to delete messages for session', { error: error.message, sessionId });
    throw error;
  }
}
...
async function countBySession(sessionId) {
  try {
    ...
    logger.error('Failed to count messages', { error: error.message, sessionId });
    throw error;
  }
}
