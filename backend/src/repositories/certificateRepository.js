...
async function getAll(options = {}) {
	try {
		...
		// Sanitize data
		const sanitizedCertificates =
			paginatedCertificates.map(sanitizeCertificate);
...
async function getById(id) {
	try {
		...
		logger.error("Failed to fetch certificate by ID", {
			error: error.message,
			id,
		});
		throw error;
...
async function getByCertificateId(certificateId) {
	try {
		...
		logger.error("Failed to fetch certificate by certificate ID", {
			error: error.message,
			certificateId,
		});
		throw error;
...
async function getBySessionId(sessionId) {
	try {
		...
		logger.error("Failed to fetch certificate by session ID", {
			error: error.message,
			sessionId,
		});
		throw error;
...
async function getByUserId(userId, options = {}) {
	try {
		...
		logger.error("Failed to fetch certificates by user ID", {
			error: error.message,
			userId,
		});
		throw error;
...
async function getPublicCertificate(certificateId) {
	try {
		...
		logger.error("Failed to fetch public certificate", {
			error: error.message,
			certificateId,
		});
		throw error;
...
async function getUserStats(userId) {
	try {
		...
		logger.error("Failed to get user certificate stats", {
			error: error.message,
			userId,
		});
		throw error;
