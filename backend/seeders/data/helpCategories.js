...
const helpCategories = [
	{
		...
		description:
			"Essential guides for new GroundCTRL operators. Start your journey here.",
		icon: "rocket",
		color: "#2563EB",
		orderIndex: 0,
		isActive: true,
	},
	{
		...
		name: "Mission Guides",
		description:
			"Step-by-step walkthroughs for each training scenario and mission.",
		icon: "target",
		color: "#16A34A",
		orderIndex: 1,
		isActive: true,
	},
	{
		...
		description:
			"Subsystems, commissioning, power, thermal, attitude, and orbital mechanics.",
		icon: "satellite",
		color: "#F97316",
		orderIndex: 2,
		isActive: true,
	},
	{
		...
		name: "Communications",
		description:
			"Ground stations, beacons, downlinks, and communication windows.",
		icon: "radio",
		color: "#0EA5E9",
		orderIndex: 3,
		isActive: true,
	},
	{
		...
		description:
			"Understanding time acceleration, simulation speeds, and mission pacing.",
		icon: "clock",
		color: "#8B5CF6",
		orderIndex: 4,
		isActive: true,
