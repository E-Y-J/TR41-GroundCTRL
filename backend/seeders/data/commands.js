...
const commands = [
	...
	// ============================================================================
	{
		...
		description:
			"Establish initial contact with satellite and verify communications link",
		parameters: {},
	...
	},
	{
		...
		subsystem: "communications",
		description:
			"Deploy communications antenna (one-time commissioning operation)",
		parameters: {},
	...
	},
	{
		...
		parameters: {
			packet_type: {
				type: "string",
				required: true,
				enum: ["health", "orbit", "attitude", "power", "thermal", "all"],
			},
		},
	...
	},
	{
		...
		parameters: {
			sensor_type: {
				type: "string",
				required: false,
				enum: ["gyro", "magnetometer", "sun_sensor", "star_tracker", "all"],
			},
		},
	...
	},
	{
		...
		parameters: {
			...
			burn_direction: {
				type: "string",
				required: true,
				enum: ["prograde", "retrograde", "normal", "anti-normal"],
			},
		},
	...
	},
	{
		...
		parameters: {
			mode: {
				type: "string",
				required: true,
				enum: ["nominal", "low-power", "emergency"],
			},
		},
		estimatedDuration: 30,
		powerRequired: 5,
