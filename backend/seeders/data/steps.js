...
const steps = [
	// DEMO_COMPLETE_HUD - Comprehensive demonstration of all command types
	{
		...
		data: {
			...
			instructions:
				"Test commissioning commands: Deploy antenna and verify beacon reception.",
	...
	},
	{
		...
		data: {
			...
			instructions:
				"Request telemetry data using dropdown to select packet type.",
			validationType: "command_executed",
			validationConfig: {
	...
	},
	{
		...
		data: {
			...
			instructions:
				"Point the satellite using the combo control (target + coordinates).",
			validationType: "command_executed",
			validationConfig: {
	...
	},
	{
		...
		data: {
			...
			instructions:
				"Toggle battery charging mode on/off using the toggle control.",
			validationType: "command_executed",
			validationConfig: {
	...
	},
	{
		...
		data: {
			...
			instructions:
				"Configure data downlink using combo control (volume + priority).",
			validationType: "command_executed",
			validationConfig: {
