...
const scenarios = [
	{
		...
		data: {
			...
			description:
				"Welcome to Mission Control! Learn to navigate the Heads-Up Display (HUD) interface, monitor satellite telemetry, and understand the essential systems that keep your satellite operational.",
			difficulty: "BEGINNER",
			tier: "ROOKIE_PILOT",
			type: "GUIDED",
...

	{
		...
		data: {
			...
			description:
				"Learn to establish contact with your satellite for the first time. Wait for beacons, ping the satellite, and deploy critical systems.",
			difficulty: "BEGINNER",
			tier: "ROOKIE_PILOT",
			type: "GUIDED",
...

	{
		...
		data: {
			...
			description:
				"Master orbital mechanics fundamentals. Learn about altitude, inclination, ground tracks, and orbital periods.",
			difficulty: "BEGINNER",
			tier: "ROOKIE_PILOT",
			type: "GUIDED",
...

	{
		...
		data: {
			...
			description:
				"Master satellite power systems. Balance solar charging, battery management, and power consumption through day/night cycles.",
			difficulty: "BEGINNER",
			tier: "ROOKIE_PILOT",
			type: "GUIDED",
...

	{
		...
		data: {
			...
			description:
				"Master ground station passes. Learn to predict visibility windows, schedule downlinks, and manage data transmission.",
...

	{
		...
		data: {
			...
			description:
				"Execute your first orbital maneuvers. Learn about delta-v, propellant management, and changing orbital parameters safely.",
			difficulty: "INTERMEDIATE",
			tier: "MISSION_SPECIALIST",
			type: "GUIDED",
...

	{
		...
		data: {
			...
			description:
				"Handle critical satellite emergencies. Practice troubleshooting, safe mode operations, and system recovery under pressure.",
			difficulty: "ADVANCED",
...

	{
		...
		data: {
			...
			description:
				"Execute a full mission from commissioning to operations. Demonstrate mastery of all satellite operations in a comprehensive scenario.",
			difficulty: "ADVANCED",
			tier: "MISSION_COMMANDER",
			type: "SANDBOX",
...

	{
		...
		data: {
			...
			description:
				"Comprehensive demonstration mission showcasing all command types and subsystems. Perfect for exploring the complete unified command interface.",
			difficulty: "INTERMEDIATE",
			tier: "MISSION_SPECIALIST",
			type: "GUIDED",
...

	{
		...
		data: {
			...
			description:
				"Experiment with satellite operations in a no-pressure environment. Perfect for learning and exploration at your own pace.",
			difficulty: "BEGINNER",
			tier: "ROOKIE_PILOT",
			type: "SANDBOX",
			estimatedDurationMinutes: 30,
