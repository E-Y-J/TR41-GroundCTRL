...
const satellites = [
	{
		...
		data: {
			...
			description:
				"Beginner training satellite for orbit fundamentals - LEO 400km ISS-like orbit",

			// TLE data for SGP4 propagation (LEO ~408km, 51.6° inclination)
			tle: {
				line1:
					"1 99991U 24001A   24031.50000000  .00001000  00000-0  50000-4 0  9991",
				line2:
					"2 99991  51.6000   0.0000 0001000   0.0000   0.0000 15.53000000    01",
			},
...

	{
		...
		data: {
			...
			description:
				"Intermediate satellite with advanced systems - Sun-synchronous polar orbit",

			// TLE data for polar orbit (~550km, 97.8° inclination)
			tle: {
				line1:
					"1 99992U 24001B   24031.50000000  .00000800  00000-0  40000-4 0  9992",
				line2:
					"2 99992  97.8000   0.0000 0001000   0.0000   0.0000 14.95000000    01",
			},
...

	{
		...
		data: {
			...
			description:
				"Advanced geostationary communications satellite - Complex mission operations",

			// TLE data for GEO orbit (~35786km, 0° inclination)
			tle: {
				line1:
					"1 99993U 24001C   24031.50000000  .00000000  00000-0  00000-0 0  9993",
				line2:
					"2 99993   0.0500   0.0000 0001000   0.0000   0.0000  1.00273791    01",
			},
